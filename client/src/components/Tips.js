                ...
                <div className="p-4">
                    ...
                    <ScrollableAnchor id={'tip2'}>
                        <div className="col col-lg-10 col-xl-10 mx-auto mb-5">
                            ...
                            <p>
                                Always check the ratings, reviews and critiques about the organization given by previous donors. These will help you confirm whether the organization is working hard enough on the cause and its relations with past and existing donors. This also helps you know if the charity is legit. Google search on the charity in order to check if they were involved in any scandal or criminal activities.
                    ...
                    <ScrollableAnchor id={'tip3'}>
                        <div className="col col-lg-10 col-xl-10 mx-auto mb-5">
                            ...
                            <p>
                                Of course, it is tempting to see your mail inbox full of letters of appreciations and honor from various charitable organizations you donate to but we recommend not to donate to more than one or few charities at a time. Please keep in mind that you do not donate more money than in your budget. Also, if you focus on donating to one or few charities then your money will be invested further in to the cause. Furthermore, you can build stronger relations with the charities. 
                    ...
                    <ScrollableAnchor id={'tip6'}>
                        <div className="col col-lg-10 col-xl-10 mx-auto mb-5">
                            ...
                            <p>
                                ...
                                For more information visit <a href="http://www.etax.com.au/claim-tax-deductible-donations" target="_blank" rel="noopener noreferrer">http://www.etax.com.au/claim-tax-deductible-donations</a>.
                            </p>
                        </div>
                    </ScrollableAnchor>

                    <div className="text-center mb-4">
                        <a className="btn btn-info" href="/charitySearch">Let’s start giving!</a>
                    </div>
